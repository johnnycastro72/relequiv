...
<html lang="es">
	...
	<body>
       <header>
           ...
           <nav class="menu">
               <ul>
                   <li><a href="../controlador/indxls.php?idPrueba=<?php echo $idPrueba ?>"><span class="lnr lnr-download"></span> Exportar</a></li>
          ...
          <script>
            function j2c() {
                ...
                var s = "../vista/individual-vista.php?idPrueba=";
        ...
        <section id="seccion">
            ...
            <table>
                ...
                //Creamos el objeto Aprendiz, Nivel, Carrera, Semestre, Modelo, Resultado
                ...
                $resultado = $objAprendiz->consultarAprendices($idPrueba);
                while ($fila = $resultado->fetch(PDO::FETCH_ASSOC))
                {
                    ...
                    $sumaTiempo = $objResultado->sumaTiempo($fila["idAprendiz"]);
                    echo "<td>" . $sumaTiempo . "</td>";
                    echo '<td align="center"><a href="../controlador/indires.php?idAprendiz=' . $fila["idAprendiz"] . '&idPrueba='. $fila["idPrueba"] . '" title="Clic para ver los resultados">' . '<img src="../recursos/1630027.png" width="30" height="30" /></a></td>';
                    echo "</tr>";
                }
                ?>
            </table>
