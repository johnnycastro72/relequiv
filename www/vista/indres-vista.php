...
<html lang="es">
	...
	<body>
       <header>
           ...
           <nav class="menu">
               <ul>
                   <li><a href="../controlador/resxls.php?idAprendiz=<?php echo $idAprendiz ?>"><span class="lnr lnr-download"></span> Exportar</a></li>
                   <li><a href="../vista/individual-vista.php?idPrueba=<?php echo $idPrueba ?>"><span class="lnr lnr-exit"></span> Volver</a></li>
               </ul>
           </nav>
     </header>
        <section id="seccion">
