       ...
       <header>
        ...
        <section id="seccion">
            ...
            <div class="container-form">
    	        <form action="../controlador/PregValidarEliminar.php?idFase=<?php echo $idFase?>&idModelo=<?php echo $idModelo?>" method="post" class="form">
    	            <div class="welcome-form">
                        <h1>Pregunta a Eliminar</h1>
	                </div>
                    ...
                    if ($fase["Diccionario"] == 0){
                        ...
                        echo '<h5>Tipo de Muestra: </h5><select id="idTipoMuestra" name="idTipoMuestra" disabled>';
                        echo $optTipo1;
                        echo '</select>';
                        echo '</div>';
                        ...
                        if ($fase["TiempoEstimulo"] == 0){
                            echo '<div class="line-input">';
                            echo '<label class="lnr lnr-select"></label>';
                            echo '<h5>Tipo de Estímulo: </h5><select id="idTipoEstimulo" name="idTipoEstimulo" disabled>';
                            echo $optTipo2;
                            echo '</select>';
                            echo '</div>';
                        }
                        ...
                        echo '<div class="line-input">';
	                    echo '<label class="lnr lnr-select"></label>';
                        echo '<h5>Muestra: </h5><select id="idMuestra" name="idMuestra" disabled>';
                        echo $optEstimulo;
                        echo '</select>';
	                    echo '</div>';
                        ...
                        echo ($pregunta['Entrenamiento']==1 ? 'checked>' : ' disabled>');
                        echo '</div>';

                        echo '<div class="line-input">';
	                    echo '<label class="lnr lnr-keyboard"></label>';
	                    echo '<input type="text" placeholder="Frase Muestra:" name="FraseMuestra" value="' . $pregunta['FraseMuestra'] . '" disabled>';
                        echo '</div>';

                        if ($fase["TiempoEstimulo"] == 0){
                            echo '<div class="line-input">';
                            echo '<label class="lnr lnr-keyboard"></label>';
                            echo '<input type="text" placeholder="Frase Estímulo" name="FraseEstimulo" value="' . $pregunta['FraseEstimulo'] . '" disabled>';
                            echo '</div>';
                        }

                        echo '<div class="line-input">';
	                    echo '<label class="lnr lnr-keyboard"></label>';
	                    echo '<input type="text" placeholder="Frase Final"name="FraseFinal" value="' .  $pregunta['FraseFinal'] . '" disabled>';
                        echo '</div>';
                        ...
                        echo '<div class="line-input">';
	                    echo '<label class="lnr lnr-keyboard"></label>';
	                    echo '<input type="text" placeholder="Frase Inicial:" name="FraseMuestra" value="' . $pregunta['FraseMuestra'] . '" disabled>';
                        echo '</div>';
                        
                        echo '<div class="line-input">';
                        echo '<label class="lnr lnr-keyboard"></label>';
                        echo '<input type="text" placeholder="Frase Confirmación" name="FraseEstimulo" value="' . $pregunta['FraseEstimulo'] . '" disabled>';
                        echo '</div>';
                        
                        echo '<div class="line-input">';
                        echo '<label class="lnr lnr-camera"></label>';
                        echo '<input type="text" placeholder="Imagén" name="FraseFinal" value="' . $pregunta["FraseFinal"] . '" readonly="readonly" disabled>';
                   ...
                   <div class="mensaje">
                        <?php
                        if ($msj==1)
                            echo '<p align="center" >Se ha Eliminado la Pregunta Correctamente';
                        if ($msj==2)
                            echo '<p align="center"> Problemas al Eliminar la Pregunta, favor Revisar';
                        ?>            
                     </div>
	            
    	            <button type="submit">Eliminar Pregunta <label class="lnr lnr-chevron-right"></label></button>
	            </form>
    		</div>
