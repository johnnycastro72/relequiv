	...
	<body>
        <section>
            <?php
                ...
                echo "<h4>" . $pregunta["FraseFinal"] . "</h4>";
            ?>
        </section>
        <?php
            echo '<form action="../controlador/preguntarffa.php?idPregunta=' . $idPregunta . '&idFase=' . $idFase . '&idModelo=' . $idModelo . '&idPrueba=' . $idPrueba . '&idAprendiz=' . $idAprendiz . '" method="post" enctype="multipart/form-data" class="form">';
