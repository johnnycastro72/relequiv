	...
	<body>
        <section>
            <?php
                ...
                //Creamos el objeto Aprendiz, Fase, Pregunta y Resultado.
                ...
                echo "<h4>" . $pregunta["FraseMuestra"] . "</h4>";
            ?>
        </section>
        <?php
            echo '<form action="../controlador/preguntarfma.php?idPregunta=' . $idPregunta . '&idFase=' . $idFase . '&idModelo=' . $idModelo . '&idPrueba=' . $idPrueba . '&idAprendiz=' . $idAprendiz . '&inicio=' . $inicio . '" method="post" enctype="multipart/form-data" class="form">';
