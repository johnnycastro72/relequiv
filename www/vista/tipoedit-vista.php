...
<html lang="es">
	...
	<body>
       <header>
            ...
            <h2>Modificando Tipo de Estímulo</h2>
        ...
        <section id="seccion">
            ...
            <div class="container-form">
    	        <form action="../controlador/TipoValidarEditar.php" method="post" class="form">
    	            <div class="welcome-form">
                        <h1>Tipo de Estímulo a Modificar</h1>
	                </div>
                    <input type="hidden" name="idTipoEstimulo" value="<?php echo $tipo['idTipoEstimulo']?>">
                    <div class="line-input">
	                    <label class="lnr lnr-keyboard"></label>
	                    <input type="text" placeholder="Nombre del Tipo de Estímulo" name="Nombre" value="<?php echo $tipo['Nombre']?>" required>
	                </div>
	            
                    <div class="mensaje">
                        <?php
                        if ($msj==1)
                            echo '<p align="center" >Se ha Modificado el Tipo de Estímulo Correctamente';
                        if ($msj==2)
                            echo '<p align="center"> Problemas al Modificar el Tipo de Estímulo, favor Revisar';
                        ?>            
                     </div>
